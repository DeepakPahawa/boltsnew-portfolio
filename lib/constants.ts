...
export const ACHIEVEMENTS = [
  {
    ...
    description:
      "Developed a language and framework agnostic Visual Studio Code extension, Multi Color Bookmark FlowWise, to bookmark a piece of code and share within a team, leading to save up to 70% of code analysis time.  was awarded with the Digital Disruptor Award (Altimetrik 2020) for creating this helpful tool. ",
    year: "2023",
    icon: "Trophy",
  },
  {
